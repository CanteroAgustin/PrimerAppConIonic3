...
@Component({
  selector: 'page-home',
  template: `<form [formGroup]="loginFrm" (ngSubmit)="loguearUsuario()">
     <ion-item>
...
export class HomePage {
  ...
  constructor(public navCtrl: NavController,
    ...
    public backendService: BackendServiceProvider) {
  ...
  loguearUsuario() {
    ...
    this.usuario = this.loginFrm.value.user;
    var passwordFrm: String = this.loginFrm.value.password;

    var password_hashed = hex_md5(passwordFrm),
      r = this.randomNumber(),
      datos = {
